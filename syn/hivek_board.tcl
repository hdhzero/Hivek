...
# File: hivek_board.tcl
# Generated on: Sat Jun 15 18:47:25 2013
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "hivek_board"]} {
		puts "Project hivek_board is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists hivek_board]} {
		project_open -revision hivek_board hivek_board
	} else {
		project_new -revision hivek_board hivek_board
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY hivek_board
	set_global_assignment -name ORIGINAL_QUARTUS_VERSION 11.0
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "12:54:42  JUNE 15, 2013"
	set_global_assignment -name LAST_QUARTUS_VERSION 11.0
	set_global_assignment -name MIN_CORE_JUNCTION_TEMP 0
	set_global_assignment -name MAX_CORE_JUNCTION_TEMP 85
	set_global_assignment -name ERROR_CHECK_FREQUENCY_DIVISOR 1
	set_global_assignment -name NOMINAL_CORE_SUPPLY_VOLTAGE 1.2V
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/writeback_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/instruction_fetch_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/instruction_expansion_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/instruction_decode_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/instruction_decode2_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/execution_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/stages/execution2_stage.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/pipeline/pipeline.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/memory/memory_bram.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/memory/icache_selector.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/memory/icache_memory.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/memory/dual_memory_bram.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/memory/dcache_selector.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/memory/dcache_memory.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/register_bank/register_bank.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/register_bank/reg_bram_altera.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/register_bank/reg_bram.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/register_bank/reg_block.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/register_bank/bank_selector.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/predicate_bank/predicate_bank.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/operation_expander/operation_expander.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/operation_decoder/operation_decoder.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/alu/barrel_shifter.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/alu/alu_shifter.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/auxiliary/alu/alu.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/hivek_pkg.vhd
	set_global_assignment -name VHDL_FILE ../src/vhdl/hivek.vhd
	set_global_assignment -name VHDL_FILE vga_ram_address_decoder.vhd
	set_global_assignment -name VHDL_FILE vga_control.vhd
	set_global_assignment -name VHDL_FILE hivek_board.vhd
